      ...
      >
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          <a
            ...
            aria-label="Try SeeSay demo immediately"
          >
            ⚡ Try Demo
          </a>
          <a
            ...
            style={{ padding: '8px 18px', minHeight: 38, fontSize: '0.88rem' }}
          ...
          <div style={{ animation: 'fadeInUp 0.7s ease both' }}>
            ...
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              ...
              <a
                ...
                id="hero-demo-btn"
                className="btn btn-ghost"
                style={{ minHeight: 56, fontSize: '1.05rem', padding: '16px 28px', border: '1px solid var(--border)' }}
                aria-label="Open SeeSay app dashboard directly"
              >
                ⚡ Open App Directly
              </a>
              <a
                href="#how-it-works"
                className="btn btn-ghost"
                style={{ minHeight: 56, fontSize: '1.05rem', padding: '16px 28px' }}
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a
              ...
              id="cta-demo-btn"
              className="btn btn-ghost"
              style={{ minHeight: 60, fontSize: '1.1rem', padding: '18px 36px', display: 'inline-flex', border: '1px solid var(--border)' }}
              aria-label="Launch SeeSay live app now"
            >
              ⚡ Launch App Directly
            </a>
          </div>
